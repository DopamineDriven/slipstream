...
function BasePopover<const T = unknown>({
  ...props
}: PopoverPrimitive.Root.Props<T>) {
  return <PopoverPrimitive.Root data-slot="popover" {...props} />;
}

function BasePopoverTrigger<const T = unknown>({
  ...props
}: PopoverPrimitive.Trigger.Props<T>) {
...
function BasePopoverDescription({
  className,
  ...props
