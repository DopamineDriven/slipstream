...
function BaseDropdown({ ...props }: MenuPrimitive.Root.Props) {
  return <MenuPrimitive.Root data-slot="dropdown-menu" {...props} />;
}

function BaseDropdownPortal({ ...props }: MenuPrimitive.Portal.Props) {
  return <MenuPrimitive.Portal data-slot="dropdown-menu-portal" {...props} />;
}

function BaseDropdownTrigger({ ...props }: MenuPrimitive.Trigger.Props) {
  return <MenuPrimitive.Trigger data-slot="dropdown-menu-trigger" {...props} />;
}

function BaseDropdownContent({
  align = "start",
  alignOffset = 0,
  side = "bottom",
  sideOffset = 4,
...
function BaseDropdownGroup({ ...props }: MenuPrimitive.Group.Props) {
  return <MenuPrimitive.Group data-slot="dropdown-menu-group" {...props} />;
}

function BaseDropdownLabel({
  className,
  inset,
  ...props
...
function BaseDropdownSub({ ...props }: MenuPrimitive.SubmenuRoot.Props) {
  return <MenuPrimitive.SubmenuRoot data-slot="dropdown-menu-sub" {...props} />;
}

function BaseDropdownSubTrigger({
  className,
  inset,
  children,
  ...props
...
function BaseDropdownSubContent({
  align = "start",
  alignOffset = -3,
  side = "right",
  sideOffset = 0,
  className,
  ...props
}: ComponentPropsWithRef<typeof BaseDropdownContent>) {
  return (
    <BaseDropdownContent
...
function BaseDropdownCheckboxItem({
  className,
  children,
  checked,
  inset,
...
function BaseDropdownRadioGroup({ ...props }: MenuPrimitive.RadioGroup.Props) {
  return (
...
function BaseDropdownRadioItem({
  className,
  children,
  inset,
  ...props
...
function BaseDropdownSeparator({
  className,
  ...props
