...
function BaseInputGroup({ className, ...props }: ComponentPropsWithRef<"div">) {
  return (
    <div
...
const baseInputGroupAddonVariants = cva(
...
function BaseInputGroupAddon({
  className,
  align = "inline-start",
  ...props
}: ComponentPropsWithRef<"div"> &
  VariantProps<typeof baseInputGroupAddonVariants>) {
  return (
    <div
      role="group"
      data-slot="input-group-addon"
      data-align={align}
      className={cn(baseInputGroupAddonVariants({ align }), className)}
      onClick={e => {
...
const baseInputGroupButtonVariants = cva(
...
function BaseInputGroupButton({
  className,
  type = "button",
  variant = "ghost",
  size = "xs",
  ...props
}: Omit<ComponentPropsWithRef<typeof BaseButton>, "size" | "type"> &
  VariantProps<typeof baseInputGroupButtonVariants> & {
  ...
  return (
    <BaseButton
      ...
      data-size={size}
      variant={variant}
      className={cn(baseInputGroupButtonVariants({ size }), className)}
      {...props}
    />
  );
}

function BaseInputGroupText({
  className,
  ...props
