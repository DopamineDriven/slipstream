...
: "${FORCE_ROLL:=1}"                         
: "${PATCH_SRC:=./infra/ws-server-taskdef.json}"    

CLUSTER_JSON="infra/remote/describe/cluster/t3-chat-clone-cluster.json"
SERVICE_JSON="infra/remote/describe/service/ws-server.json"
PATCHED_OUT="infra/remote/updates/taskdef/ws-server.json"
REV_OUT="infra/remote/describe/revisions/taskdef/ws-server.json"
...
else SRC="infra/remote/describe/taskdef/ws-server.json"
fi
