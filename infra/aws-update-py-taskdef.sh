...
TASKDEF_REVISION_ARN=$(jq -r '.taskDefinition.taskDefinitionArn' infra/remote/describe/revisions/taskdef/t3-chat-clone-python-service.json)
...
aws ecs update-service \
  ...
  >infra/remote/describe/updates/taskdef/"$SERVICE_NAME".json
