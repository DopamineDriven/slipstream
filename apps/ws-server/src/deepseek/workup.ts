...
import type { DeepSeekModelIdUnion, LocalToolName } from "@slipstream/types";
...
export class DeepSeekWorkupService {
  ...
  protected fileSearchFunctionTool() {
    return this.prisma.FileSearchTool() satisfies DeepSeekFunctionTool;
  }

  protected memorySearchFunctionTool() {
    return this.prisma.memorySearchTool() satisfies DeepSeekFunctionTool;
  }

  protected memoryGetChunkFunctionTool() {
    return this.prisma.memoryGetChunkTool() satisfies DeepSeekFunctionTool;
  }
}
