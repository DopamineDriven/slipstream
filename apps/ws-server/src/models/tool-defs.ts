...
export class ModelToolDefsService extends ModelServiceWorkup {
  ...
  public fileSearchToolOpenAI<const T extends string>(
    name = "file_search" as T
  ) {
    return {
      type: "function",
      name,
  ...
  public memoryGetChunkToolOpenAI() {
    return {
      type: "function",
      name: "conversation_memory_get_chunk",
      description:
