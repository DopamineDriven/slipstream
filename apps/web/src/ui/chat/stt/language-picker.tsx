...
import { SelectionIndicator } from "@/ui/chat/stt/selection-indicator";
import { accelerateThenGlide } from "@/ui/chat/stt/utils";
...
export function LanguagePicker({
  ...
  }, [draft, query, quickSwitchRequest]);
