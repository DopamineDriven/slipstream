...
export class ImgMetadataExtractor extends ImgMetadataExtractorWorkup {
  ...
  protected avif(buffer: Buffer<ArrayBufferLike>) {
  ...
  protected svg(headerText: string) {
  ...
  public getImageSpecsWorkup(
    ...
    if (
      ...
      return this.ico(rawbuffer, buffer);
    }
    ...
    if (
      ...
      return this.tiff(rawbuffer, buffer);
    }
