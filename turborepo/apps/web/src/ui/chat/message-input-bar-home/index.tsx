...
import { handlePromptSubmission } from "@/app/actions/new-chat-submit";
...
export function MessageInputBarHome({
  ...
  const handleFullscreenSubmit = (full: string) => {
    setMessage(full);
  };
  ...
  return (
    <>
      <motion.div
        ...
        <Form action={handlePromptSubmission} className="appearance-none">
