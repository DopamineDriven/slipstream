...
import { ChatScrollProvider, useChatScroll } from "@/context/chat-scroll-context";
...
// Floating scroll button that uses context - must be inside ChatScrollProvider
function FloatingScrollButton({ isHome }: { isHome: boolean }) {
