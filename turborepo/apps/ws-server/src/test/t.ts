...
console.log(s);
GlobalFonts.registerFromPath(relative(process.cwd(), resolve("/usr/share/fonts/truetype/noto", "NotoColorEmoji.ttf")), "Noto Color Emoji")
GlobalFonts.registerFromPath(relative(process.cwd(), "src/test/__out__/emojis/fonts/AppleColorEmoji_WindowsCompatible.ttf"), "Apple Emoji")



fs.withWs("src/test/__out__/global-fonts/families.json", JSON.stringify(GlobalFonts.families, null, 2))
